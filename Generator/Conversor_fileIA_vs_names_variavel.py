...
NameFileExport = "data_validation_Exportação_dados_Validação_2_milhoes.csv"
def __main__():
    ...
    patient = []
    for n in range(100):
        reader = csv.reader(open(r'D:\Mestrado\MasterMedicalDecisionSupport\E1xportação_dados_Validação_2_milhoes_0e1e2.csv'))
...
def createFile():
    ...
    arq.write('NAME_PATIENT,NEUROLOGICAL,DESCR_NEUROLOGICAL,CARDIOVASCULAR,DESCR_CARDIOVASCULAR,RESPIRATORY,DESCR_RESPIRATORY,COAGULATION,DESCR_COAGULATION,HEPATIC,DESCR_HEPATIC,RENAL,DESCR_RENAL,SPICT,DESCR_SPICT,ECOG,DESCR_ECOG,SOFA,AMIB,NAME_PATIENT,NEUROLOGICAL,DESCR_NEUROLOGICAL,CARDIOVASCULAR,DESCR_CARDIOVASCULAR,RESPIRATORY,DESCR_RESPIRATORY,COAGULATION,DESCR_COAGULATION,HEPATIC,DESCR_HEPATIC,RENAL,DESCR_RENAL,SPICT,DESCR_SPICT,ECOG,DESCR_ECOG,SOFA,AMIB,CLASSARQ,CLASSIA')
    arq.close()
